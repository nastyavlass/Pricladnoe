...
namespace CompanyEmployess.Controllers
{
    ...
    public class FurnitureController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetAppliances() {
            var furniture = await _repository.Furniture.GetAllFurniture(trackChanges: false);
        ...
        {
            var furniture = await _repository.Furniture.GetFurniture(furnitureId, trackChanges: false);
            if (furniture == null)
            {
        ...
        public async Task<IActionResult> UpdateFurniture(Guid furnitureId, [FromBody] FurnitureForUpdateDto furniture)
        {
            ...
            var furnitureEntity = await _repository.Furniture.GetFurniture(furnitureId, trackChanges: false);
